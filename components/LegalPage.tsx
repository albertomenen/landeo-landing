...
const documents: Record<LandingLocale, Record<LegalKind, LegalDocument>> = {
  en: {
    privacy: {
      ...
      sections: [
        { title: "1. Who is responsible", paragraphs: [
          `The data controller for Landeo is Alberto Menendez, an individual established in Spain. Privacy questions and requests can be sent to ${contact}.`,
    ...
    terms: {
      ...
      sections: [
        { title: "1. Provider and acceptance", paragraphs: [`Landeo is provided by Alberto Menendez, an individual established in Spain. Contact: ${contact}. By creating an account or using Landeo, you agree to these Terms and the Privacy Policy.`] },
        ...
        { title: "15. Apple App Store addendum", bullets: [
          "These Terms are between you and Alberto Menendez, not Apple. The provider, not Apple, is solely responsible for Landeo and its content.",
  ...
  es: {
    privacy: {
      ...
      sections: [
        { title: "1. Responsable del tratamiento", paragraphs: [
          `El responsable del tratamiento de Landeo es Alberto Menendez, persona física establecida en España. Puedes enviar consultas y solicitudes de privacidad a ${contact}.`,
    ...
    terms: {
      ...
      sections: [
        { title: "1. Prestador y aceptación", paragraphs: [`Landeo es prestado por Alberto Menendez, persona física establecida en España. Contacto: ${contact}. Al crear una cuenta o utilizar Landeo, aceptas estos Términos y la Política de privacidad.`] },
